...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Fuel.INSTANCE.post("http://192.168.1.162:5000/payment-sheet", null).responseString(new Handler<String>() { //use if on computer http://192.168.1.162:5000/payment-sheet
            @Override
